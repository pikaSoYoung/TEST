...
(function(){
		...
		var boardListPrint = function(searchCnd,searchWd,choicePage){
			...
			var url = "boardList.do"; //data를 보낼 url	
			var data = {} 
			...
			paging.ajaxSubmit(url,data,function(result){
				...
				if(result==null || result.length<=0){return false;}//if
				
				thisList = result;			
				totalNoticeNum = thisList[0].totalNoticeNum; //총 게시물 수			
				count = totalNoticeNum - ((data.choicePage-1)*viewNoticeMaxNum); //게시물 출력 번호 구하기
...
<body>
	<div class='wrap'>
		<h2>게시판</h2>
    	<fieldset>
        	<form class="search_form" action="boardDetail.do" name="searchForm" method="post">
		...
		<div class="unrole">
        	...
        	<a href="boardWrite.do" title="글등록" class="unrole_btn"><span>등록</span></a>
    	</div>	
	</div>
</body>
</html>