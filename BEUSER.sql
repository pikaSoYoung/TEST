...
CREATE SEQUENCE BEUSER.REBOARD_NO_SEQ
  START WITH 1
  MAXVALUE 10000
  MINVALUE 1
  NOCYCLE
...
CREATE SEQUENCE BEUSER.P_FILE_SEQ
  START WITH 1
  MAXVALUE 10000
  MINVALUE 1
  NOCYCLE
...
CREATE SEQUENCE BEUSER.REPLY_NO_SEQ
  START WITH 1
  MAXVALUE 10000
  MINVALUE 1
  NOCYCLE
...
CREATE TABLE BEUSER.POPUP
(
  P_FILE_NO      NUMBER(5),
  P_SYS_NM       VARCHAR2(500 BYTE),
  P_ORG_NM       VARCHAR2(500 BYTE),
  P_TITLE        VARCHAR2(300 BYTE),
  P_URL          VARCHAR2(1000 BYTE),
  P_IDX          NUMBER(20),
  P_START_DATE   VARCHAR2(14 BYTE),
  P_END_DATE     VARCHAR2(14 BYTE),
  P_CREATE_DATE  VARCHAR2(14 BYTE),
  P_DEL_YN       CHAR(1 BYTE)
)
TABLESPACE BEGINNING
PCTUSED    0
PCTFREE    10
...
CREATE UNIQUE INDEX BEUSER.TBL_BOARD_PK ON BEUSER.TBL_BOARD
(BOARD_NO)
LOGGING
TABLESPACE BEGINNING
PCTFREE    10
...
ALTER TABLE BEUSER.TBL_BOARD ADD (
...
CREATE UNIQUE INDEX BEUSER.TBL_REPLY_PK ON BEUSER.TBL_REPLY
(BOARD_NO, REPLY_NO)
LOGGING
TABLESPACE BEGINNING
PCTFREE    10
...
ALTER TABLE BEUSER.TBL_REPLY ADD (
  CONSTRAINT TBL_REPLY_PK
  PRIMARY KEY
  (BOARD_NO, REPLY_NO)
  USING INDEX BEUSER.TBL_REPLY_PK
  ENABLE VALIDATE);

ALTER TABLE BEUSER.TBL_REPLY ADD (
  CONSTRAINT BOARD_NO 
  FOREIGN KEY (BOARD_NO) 
  REFERENCES BEUSER.TBL_BOARD (BOARD_NO)
  ENABLE VALIDATE);
